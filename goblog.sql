...
CREATE TABLE `t_moodlist` (
  ...
  `likes` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '点赞',
  `shits` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '吐槽',
  `is_top` tinyint(3) NOT NULL DEFAULT '0' COMMENT '是否置顶',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
